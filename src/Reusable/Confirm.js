...
function Confirm({setShowDeleteModal}) {
  return (
    <div class="fixed inset-0 flex items-center justify-center z-50 bg-black/40 confirm-dialog ">
          ...
          <div class="md:flex items-center">
            ...
            <div class="mt-4 md:mt-0 md:ml-6 text-center md:text-left">
              ...
              <p class="text-sm text-gray-700 mt-1">
                You will lose this file after deleting it. This action
                cannot be undone.
              </p>
            </div>
          </div>
